...
echo ***   liam    ***
echo *****************
bin\out\debug\liam ".\testdata\shtemu\basic.ara.ls"
bin\out\debug\liam ".\testdata\shtemu\.target.ara.ls"
...
echo ***   shtasm    ***
echo *******************
bin\out\debug\shtasm ".\testdata\shtemu\basic.ara.ls.asm"
bin\out\debug\shtasm ".\testdata\shtemu\.target.ara.ls.asm"
