...
.sht.cons.iStream_sctor: 
                         ...
                         add, rsp, 32                          
                         mov, r10, .sht.cons.iStream_vtbl_inst ; codeshape decomp
                         mov, [rcx], r10                       ; =
                         sub, rsp, 32                          
...
.sht.cons.program_sctor: 
                         ...
                         call, .sht.core.object_sctor          ; (call label)
                         add, rsp, 32                          
                         mov, r10, .sht.cons.program_vtbl_inst ; codeshape decomp
                         mov, [rcx], r10                       ; =
                         sub, rsp, 32                          
...
.sht.cons.stdout_sctor: 
                        ...
                        add, rsp, 32                         
                        mov, r10, .sht.cons.stdout_vtbl_inst ; codeshape decomp
                        mov, [rcx], r10                      ; =
                        sub, rsp, 32                         
